...
func setupTestData(db *gorm.DB) {
	items := []models.Item{
		...
		{Name: "テストアイテム2", Price: 2000, Description: "", SoldOut: true, UserID: 1},
		{Name: "テストアイテム3", Price: 3000, Description: "", SoldOut: false, UserID: 2},
	}

	users := []models.User{
		{Email: "test1example.com", Password: "test1pass"},
		{Email: "test2example.com", Password: "test2pass"},
	}
...
func TestCreate(t *testing.T) {
	...
	token, err := services.CreateToken(1, "test1example.com")
